...
public class UserHttpServletRequest extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 5. 출력 내용 작성
	      ...
	      // println 은 소스보기를 통해 html 코드 확인시 개행(줄 바뀜)이 되어있는 걸 확인 할 수 있고
	      // print는 한줄로 작성이 되어있는 걸 확인할 수 있다.
...
//	      out.println("<br>");
	      ...
	      out.print("\t\t<li><strong>요청한 QueryString</strong> : ");

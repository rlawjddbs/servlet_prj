...
public class UseSessionB extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// 다른 클래스(UseSessionA)에서 사용한 값을 이동한 페이지(UseSessionB)에서
		...
		if (id == null) {
			// 세션에 값이 없다면
			// 이 페이지의 URL을 직접 넣고 들어왔는가? - 이를 보고 "비정상적인 요청 발생"이라 한다.
			// 정상적인 요청을 했지만 세션의 사용시간을 초과한 경우
		...
		out.print("(<strong>");
		out.print(id);
		out.print("</strong>)님의 작업 페이지입니다.<br />");

...
public class ForwardB2 extends HttpServlet {

   // 이동 전 페이지의 요청 처리 방식이 POST라면 여기또한 처리 방식을 POST로 작업해야 한다.
   // 디자인에 집중한다.
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      PrintWriter out = response.getWriter();
         ...
         // checkbox의 값을 가져와서
         out.println("\toutput='프로잭트명 ['+prj_name+']<br/>참여인원 :';");
